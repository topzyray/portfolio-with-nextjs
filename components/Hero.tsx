...
const Hero = () => {
  return (
    <div className="pb-[4.5rem] pt-[4.5rem] md:pb-20 md:pt-36">
      <div>
        <Spotlight
        ...
        <Spotlight className="top-40 right-0 h-[50vh] w-full" fill="purple" />
      </div>
        ...
        _blank"
          >
            <img
              src="/tope.png"
              alt="Tope Taiwo"
              className="w-16 md:w-20 lg:w-24 py-6 rounded-full shadow-2xl opacity-50"
            />
          </Link>
